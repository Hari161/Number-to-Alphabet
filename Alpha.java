...
public class Alpha {
	...
	public static void main(String[] args) {
		...
		int n1, m1, a1,temp1=0,count=0,temp2=0;
  ...
  //so next time if we have a number it will add into the position of zero and so on
           ...
           //setting an counter variable to skip first step to avoid being added by zero at the end  
          ...
          //checking the combination that varying from 10 to 26 to avoid array index out of bond exception  	  
